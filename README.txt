...
a persistence unit "serviecesPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "servieces\pom.xml":
...
artifact ("servieces.war") is already built. You can build
